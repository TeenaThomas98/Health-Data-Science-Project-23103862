...
### Creating Maps for low birth weight prevelance at the state and district level
...
```{r}
# Loaded district-level shapefile from GADM
...
```{r}
# Create a vector with all the district names in NFHS
...
# Create a vector with all the district names in GADM
